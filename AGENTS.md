...
This file (`AGENTS.md`) contains the shared rules and setup instructions for all Jules agents operating on this codebase.
...
Read `.jules/<name>.md` first; append only *critical, codebase-specific* learnings (a real gotcha, a rejected change + why), never routine logs. Ensure `.jules/` directory exists before writing.
Format:
```markdown
## YYYY-MM-DD — [Title]
**Learning:** ...
