# Jules Agent Library - Shared Rules

Every agent operating in this codebase must strictly adhere to the following shared rules.

## Environment / verify (mirror CI)
Ensure your environment matches CI (`.github/workflows/ci.yml`). Run this setup block before executing tests:
```bash
