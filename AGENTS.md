...
The prompts live in `agents/`. Paste one into a Jules scheduled task, or point Jules at the file. Journals live in `.jules/<name>.md` (the agent maintains its own).
