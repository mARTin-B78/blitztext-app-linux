...
> **Inspiration Credit:** Blitztext App Linux is inspired by [cmagnussen/blitztext-app](https://github.com/cmagnussen/blitztext-app).
> Any project-facing documentation changes must keep this attribution intact.
