...
This file contains shared rules and setup instructions for the Jules agents that patrol this codebase.

## Environment / Verify

Mirror CI (`.github/workflows/ci.yml`) for the working environment:
