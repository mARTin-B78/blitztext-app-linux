...
This file contains shared rules that every Jules agent patrolling this codebase must obey.
...
Ensure this setup is followed so every Jules run starts from a working environment.
