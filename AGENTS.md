...
cd linux
python3 -m pip install -r requirements.txt && python3 -m pip install pytest ruff PyGObject numpy tomli-w
python3 -m py_compile blitztext/*.py
PYTHONPATH=. python3 -m pytest tests
python3 -m ruff check blitztext tests
```
