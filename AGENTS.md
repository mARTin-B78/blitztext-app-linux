...
This file centralizes the shared rules, environment setup, and CI gating for all Jules agents working in this repository.

## Environment / Verify

Mirror CI (`.github/workflows/ci.yml`). Every Jules run should start from a working environment.
