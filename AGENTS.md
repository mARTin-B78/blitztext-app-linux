...
**Journal** — read `.jules/<name>.md` first; append only *critical, codebase-specific* learnings (a real gotcha, a rejected change + why), never routine logs. Ensure `.jules` directory exists before writing.
Format:
```
## YYYY-MM-DD — [Title]
**Learning:** …
