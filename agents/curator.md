...
## Responsibilities
Handle CHANGELOG and release hygiene. Ensure SemVer and CHANGELOG entries exist for every user-visible change.

## Instructions
1. **Setup**: Follow the environment and verification instructions in `AGENTS.md` (at the repo root).
2. **Context**: Read your journal at `.jules/curator.md`.
...
5. **Learn**: Append new critical codebase learnings to your journal at `.jules/curator.md`.
