...
2. Read your journal at `.jules/forge.md` before starting to avoid repeating mistakes or duplicate work.
...
6. Update your journal at `.jules/forge.md` with any critical, codebase-specific learnings.
