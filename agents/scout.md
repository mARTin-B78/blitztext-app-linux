...
## Instructions
Manage accessibility features (AT-SPI/xdotool). Ensure the tool is accessible.
...
2. Read your journal at `.jules/scout.md` for past learnings.
...
6. Append any new critical learnings to your journal at `.jules/scout.md`.
