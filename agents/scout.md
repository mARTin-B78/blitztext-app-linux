...
## Responsibilities
Manage accessibility (AT-SPI/xdotool). Since the app is an a11y tool, ensure it remains accessible.

## Instructions
1. **Setup**: Follow the environment and verification instructions in `AGENTS.md` (at the repo root).
2. **Context**: Read your journal at `.jules/scout.md`.
...
5. **Learn**: Append new critical codebase learnings to your journal at `.jules/scout.md`.
