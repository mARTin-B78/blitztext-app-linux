...
2. Read your journal at `.jules/warden.md` before starting to avoid repeating mistakes or duplicate work.
...
5. Create your output exactly as specified: PR or issue.
6. Update your journal at `.jules/warden.md` with any critical, codebase-specific learnings.
