                    ...
                    while read_active and not self._stop_event.is_set():
                        try:
                            ...
                            while not line.endswith(b"\n"):
                                ...
                                line += byte
                                if len(line) > 65536:
                                    raise ConnectionError("Header length exceeded 64KB limit")
                            ...
                            if data_len > 1048576:
                                raise ConnectionError("Data length exceeded 1MB limit")
                            if data_len > 0:
                                data_bytes = b""
                            ...
                            if payload_len > 1048576:
                                raise ConnectionError("Payload length exceeded 1MB limit")
                            if payload_len > 0:
                                # Consume payload
